...
To see the changes and explaination in a better way and proof of speed-ups, you can find the ReadMe.md file on https://github.com/taaanmay/TK-Concurrent-Systems.git 
